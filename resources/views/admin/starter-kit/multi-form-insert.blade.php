@component('admin.master')
	...
	<div class="rows text-left" dir="ltr">
		<div class="col-md-12">
			{{---------------------------------------------- form A --------------------------------------------------}}
			<form id="form_A" role="form" class="form-horizontal" action="{{-- {{ route('create', ['form' => 'A']) }} --}}" method="POST">
				@method("POST")
				@csrf
			...
			{{--------------------------------------------- form B ---------------------------------------------------}}
			<form id="form_B" role="form" class="form-horizontal" action="{{-- {{ route('create', ['form' => 'B']) }} --}}" method="POST">
				@method("POST")
				@csrf
				<div class="card card-primary">
					<div class="card-header text-center">
